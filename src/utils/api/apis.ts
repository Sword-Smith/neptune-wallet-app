...
export const requestLatestBlock = ({ serverUrl }: { serverUrl: string }) => {
...
export const requestStartScanBlockStatus = ({ serverUrl }: { serverUrl: string }) => {
  let { rpc } = handleServiceUrl(serverUrl);
  return service({
...
export const requestWalletBalance = ({ serverUrl }: { serverUrl: string }) => {
  let { rpc } = handleServiceUrl(serverUrl);
  return service({
...
export const requestActivityTransactions = ({ serverUrl }: { serverUrl: string }) => {
  let { rpc } = handleServiceUrl(serverUrl);
  return service({
...
export const requestPendingTransactions = ({ serverUrl }: { serverUrl: string }) => {
  let { rpc } = handleServiceUrl(serverUrl);
  return service({
...
export const requestAvailableUtxos = ({ serverUrl }: { serverUrl: string }) => {
  let { rpc } = handleServiceUrl(serverUrl);
  return service({

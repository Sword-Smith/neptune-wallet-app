...
>("/api/execution/queryExecutionHistorys", async ({ addressId, serverUrl }) => {
...
>("/api/execution/addExecutionTransactionHistory", async ({ addressId, history, serverUrl }) => {
  let newLocalHistory = [] as ExecutionHistory[];
  try {
...
>("/api/execution/removeExecutionTransactionHistory", async ({ txid, addressId, serverUrl }) => {
...
export const { updateSendState } = executionSlice.actions;

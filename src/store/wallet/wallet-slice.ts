...
export const queryCurrentWalletID = createAsyncThunk<{ data: number }>(
...
export const queryWalletBalance = createAsyncThunk<
  ...
  { serverUrl: string }
>("/api/balance/queryWalletBalance", async ({ serverUrl }) => {
...
export const queryCurrentWallet = createAsyncThunk<{ currentAddress: string }>(
...
export const { setMnemonic, setOneTimeWalletName, setOneTimePassword } = walletSlice.actions;
